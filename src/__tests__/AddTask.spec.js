...
describe("<AddTask />", () => {
  ...
  describe("Success", () => {
    ...
    it("renders <AddTask /> and adds a task with the task date of TODAY", () => {
      useSelectedProjectValue.mockImplementation(() => ({
        selectedProject: "1",
      }));
    ...
    it("renders <AddTask /> and adds a task with the task date of TOMORROW", () => {
      useSelectedProjectValue.mockImplementation(() => ({
        selectedProject: "1",
      }));
    ...
    it("renders <AddTask /> and adds a task with the task date of NEXT_7", () => {
      useSelectedProjectValue.mockImplementation(() => ({
        selectedProject: "1",
      }));
